          ...
          <q-card class="q-pa-md">
            ...
            <q-card-section>
              ...
              <q-input
                ...
                disable
              />
              <label class="text-weight-medium q-px-md">First Name</label>
              <q-input
                v-model="firstName"
                ref="firstNameRef"
                type="text"
                ...
                class="q-px-md q-mb-md"
              />
              <label class="text-weight-medium q-px-md">Last Name</label>
              <q-input
                v-model="lastName"
                ref="lastNameRef"
                type="text"
              ...
              <q-input
                ...
                @keydown.enter.prevent="completeRegistration"
                class="q-px-md q-mb-md"
              >
                <template v-slot:append>
                  <q-icon
